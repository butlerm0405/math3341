...
class Compiler():
    ...
    def generate_filename(self):
        ...
        if len(metadata) == 2:
            ...
            # ]
            self.filename = [
                '{0}.{1}.{2}.pdf'.format(subject, course_number, doc_number),
                '{0}.{1}.{2}.{3}.{4}.pdf'.format(subject, course_number,
                                                     doc_number,
                                                     self.last_name,
                                                     self.first_name),
    ...
    def generate_title(self):
        ...
        elif course_number == '5380':
            course_name = 'Bayesian Data Analysis'
        elif course_number == '3340':
            course_name = 'Scientific Computing'
        elif course_number == '5265':
            course_name = 'Introductory Theory of Statistics'

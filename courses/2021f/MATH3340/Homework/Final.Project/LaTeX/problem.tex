...
\usepackage{
  ...
  caption,color,enumerate,enumitem,fancyhdr,float,fontspec,geometry,
  graphicx,grffile,hyperref,hyphenat,ifthen,imakeidx,indentfirst,lastpage,
  lipsum,listings,longtable,makeidx,mathtools,multicol,subcaption,tikz,
  tikzscale,titlesec,titling,verbatim,xcolor,xltxtra,xunicode
}

\title{MATH 3340 - Scientific Computing Final Project}
\author{}
\date{Due: Friday, 05/14/2021, 05:00 PM}
